...
example 1: 
Content: "Rates will be massively up next month!", "Inflation running red hot implying hawkish outlook", "I see the FED moving up in line with inflation"
output (correct): +1

example 2: 
Content: "Inflation hard to predict next month- I see upward AND downward momentum so rates unclear", "FOMC gonna keep rates steady", "*Article unrelated to rates*"
output (correct): 0

example 3: 
Content: "I think Powell has to cut rates at the next meet", "Inflation cooling big time- Fed need to lower rates", "inflation tracking down this month- rates should follow"
output (correct): -1
...
df_finetune.to_csv("finetune_data.csv", index=False)
